...
//		{
//			return new TESTRESULT<T1, T2>() { PassesTest = false, ResultObvervation = $"Failed to complete action" };
//		}
...
//		{
//			return new TESTRESULT<T1, T2>() { PassesTest = false, ResultObvervation = $"Failed to complete action (result value: '{result}')" };
//		}
...
//		{
//			return new TESTRESULT<T1, T2>() { PassesTest = false, ResultObvervation = $"Failed to generate list (result value: '{result}')" };
//		}
...
//		{
//			return new TESTRESULT<T1, T2>() { PassesTest = false, ResultObvervation = $"Failed to generate collector (result value: '{result}')" };
//		}
